  ...
  return (
    <Container id="project">
      ...
      <p className="subtitle">
        I made this app at my internship at Kuubix where Master Interior was our customer.
        This app is made for customers and personel. As a customer u can view
        your orders, offers, invoices and manage your account details. Personel
        can also manage projects and clients.
      </p>
      <div className="projects" style={{ marginTop: "5rem" }}>
        <div className="project">
          <div className="content">
            ...
            <p className="left">
              ...
              login first to get access to other routes.
            </p>
            <img
        ...
        <div className="project">
          <div className="content">
            ...
            <p className="right">
              If a user forgot his password he can request a reset password
              email.
            </p>
            <img
        ...
        <div className="project">
          <div className="content">
            <h3>Orders</h3>
            <p className="left">Here a user can view his orders.</p>
            <img
        ...
        <div className="project">
          <div className="content">
            <h3>Order details</h3>
            <p className="right">
              If a user clicks on an order he can view the details of that
              order.
            </p>
            <img
        ...
        <div className="project">
          <div className="content">
            ...
            <p className="left">Here a user can manage his account details.</p>
            <img
        ...
        <div className="project">
          <div className="content">
            ...
            <p className="right">Here a user can change his password.</p>
            <img
